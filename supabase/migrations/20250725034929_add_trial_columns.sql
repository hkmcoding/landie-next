-- Add trial and Stripe integration columns to user_pro_status table
...
create unique index if not exists user_pro_status_stripe_customer_id_key 
on public.user_pro_status (stripe_customer_id) 
